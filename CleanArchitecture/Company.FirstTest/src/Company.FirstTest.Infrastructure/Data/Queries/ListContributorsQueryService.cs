using Company.FirstTest.UseCases.Contributors;
using Company.FirstTest.UseCases.Contributors.List;

namespace Company.FirstTest.Infrastructure.Data.Queries;
