...
using Company.FirstTest.Core.ProjectAggregate;
using Company.FirstTest.Core.Services;
using Company.FirstTest.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace Company.FirstTest.UnitTests.Core.Services
{
