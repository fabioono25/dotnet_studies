...
namespace BasicStore.Sales.Domain
{
    public class Pedido : Entity, IAggregateRoot
    {
        ...
        // nao quero expor essa lista para ser manipulada por outra classe
        // propriedade usada internamente por esta classe 
        private readonly List<PedidoItem> _pedidoItems;
        public IReadOnlyCollection<PedidoItem> PedidoItems => _pedidoItems;

        // EF necessity
        //public virtual Voucher Voucher { get; private set; } // with lazy loading
        ...
        // raiz da agregacao precisa chamar atualizar unidades do pedido item
        ...
        // ajudando a criar um pedido como rascunho
